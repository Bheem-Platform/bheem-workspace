...
export default function VideosPage() {
  ...
  const handleStarToggle = async (video: VideoItem, e: React.MouseEvent) => {
    e.stopPropagation();
    try {
      await api.post(`/api/v1/videos/${video.id}/star`);
      fetchVideos();
    } catch (error) {
        ...
        >
          ...
          <div className="flex-1 max-w-7xl mx-auto px-6 py-8 w-full">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="flex items-center gap-2 px-4 py-2.5 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition-colors">
                <Upload size={20} />
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <button className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition-colors">
                  <Plus size={20} />
                  <span>Upload Video</span>
                </button>
              </div>
