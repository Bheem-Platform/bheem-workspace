...
export default function MailHeader({ onSearch }: MailHeaderProps) {
      ...
      <div className="flex-1 max-w-xl mx-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 bg-white/10 border border-white/10 rounded-lg text-white placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:bg-white/15 transition-all"
          />
        </div>
      </div>
