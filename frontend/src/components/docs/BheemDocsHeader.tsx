/**
 * Bheem Docs Header Component
 * Custom branded header for the document editor
 */
...
interface BheemDocsHeaderProps {
  title: string;
  isFavorite: boolean;
  isSaving: boolean;
  isSaved: boolean;
...
export default function BheemDocsHeader({
  title,
  isFavorite,
  isSaving,
  isSaved,
